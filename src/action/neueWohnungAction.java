    ...
    public void action() {
        ...
        while (erstellVorgang == true) {
            ...
            if (ok == 13) {
                ...
                MenuManager.flatList.add(new Wohnung(ID, zimmeranzahl, fl‰che, kosten, etage, balkon, fuﬂbodenheizung, aussicht, status, letztesRenovierungsdatum, "", renovierungsanzahl, letzeRenovierung_Details, new Mitarbeiter(zugeordneterMitarbeiter)));
            }
            if (ok == 14) {
                erstellVorgang = false;
            }
