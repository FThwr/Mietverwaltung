            ...
            try {
                ...
                if (änderung == 8) {
                    ...
                    if (neuerStatus.equals("ausgelaufen")) {
                         ...
                         */
                        MenuManager.addBeendeteMietverträge(new Mietvertrag(neueMietvertragsID, neueWohnungsID, neueKundenID, neueMitarbeiterID, neuerMietbeginn, neuesMietende, neuerStatus));
