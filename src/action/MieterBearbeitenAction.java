            ...
            try {
                ...
                if (änderung == 10) {
                    ...
                    if (neueRolle.equals("Delete")) {
                        ...
                        MenuManager.addEhemaligeMieter(new Mieter(neueMieterID, neuerName, neuerVorname, neuesGeburtsdatum, neueWohnung, neueEMail, neueAdresse, neueTelefonnummer, "Mieter"));
