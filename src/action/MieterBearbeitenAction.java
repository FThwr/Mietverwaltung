...
public class MieterBearbeitenAction extends MenuManager implements Action, Serializable {
			...
			try {
				...
				if (änderung == 10) {
					...
					if (neueRolle.equals("Delete")) {
						...
						MenuManager.ehemaligeMieter.add(new Mieter(neueMieterID, neuerName, neuerVorname,
								neuesGeburtsdatum, neueWohnung, neueEMail, neueAdresse, neueTelefonnummer, "Mieter"));
	...
	public Datum Datum_Eingabe(final Datum aktuellesDatum) {
		...
		System.out.println(
				"Eingabe des Eingangdatums: Wählen Sie bei einem Wert '0' und das Datum bleibt unverändert!\n");
