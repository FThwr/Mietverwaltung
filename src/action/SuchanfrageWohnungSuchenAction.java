        ...
        while (suchVorgang == true) {
            ...
            try {
                ...
                if (eingabe == 8) {
                    ...
                    MenuManager.add(new Suchanfrage(SuchanfrageWohnungSuchenAction.such_mitarbeiterID, SuchanfrageWohnungSuchenAction.such_kundenID, zimmeranzahl_rela, such_zimmeranzahl, fläche_rela, such_fläche, kosten_rela, such_kosten, etage_rela, such_etage, such_balkon, such_fußbodenheizung, such_aussicht));
