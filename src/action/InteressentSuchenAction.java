            ...
            try {
                ...
                if (eingabe == 7) {
                    ...
                    for (Interessent interest : MenuManager.getInterestList()) {
                         ...
                         */
                        if (vgl_interessentenID == such_interessentenID && vgl_name.contains(such_name) && vgl_vorname.contains(such_vorname) && vgl_EMail.contains(such_EMail) && vgl_adresse_straße.contains(such_adresse_straße) && vgl_adresse_plz == such_adresse_plz && vgl_telefon.contains(such_telefon)) {
