...
public class HandwerkerauftragBearbeitenAction extends MenuManager implements Action, Serializable {
    ...
    public void action() {
        ...
        while (bearbeitungsVorgang == true) {
            ...
            System.out.println("1. Auftrags ID:          " + längenAnpassung_auftragsID + "neue Auftrags ID:           " + neueAuftragsID);
            System.out.println("2. Wohnungs ID:          " + längenAnpassung_wohnungsID + "neue Wohnungs ID:           " + neueWohnungsID);
            System.out.println("3. Mitarbeiter ID:       " + längenAnpassung_mitarbeiterID + "neue Mitarbeiter ID:        " + neueMitarbeiterID);
            System.out.println("4. Mängelbeschreibung:   " + längenAnpassung_mängelbeschreibung + "neue Mängelbeschreibung:    " + neueMängelbeschreibung);
            System.out.println("5. Status:               " + längenAnpassung_status + "neuer Status:               " + neuerStatus);
            System.out.println("6. Eingangsdatum:        " + aktuellesEingangsdatum + ED_Leerzeichen + "neues Eingangsdatum:        " + neuesEingangsdatum);
            System.out.println("7. Fertigstellungsdatum: " + aktuellesFertigstellungsdatum + FD_Leerzeichen + "neues Fertigstellungsdatum: " + neuesFertigstellungsdatum);
            ...
            try {
                ...
                if (änderung == 8) {
                    ...
                    if (neuerStatus.equals("beendet")) {
                         ...
                         */
                        MenuManager.addAbgeschlosseneHandwerkeraufträge(new Handwerkerauftrag(neueAuftragsID, neueWohnungsID, +neueMitarbeiterID, neueMängelbeschreibung, neuerStatus, neuesEingangsdatum, aktuellesFertigstellungsdatum));
