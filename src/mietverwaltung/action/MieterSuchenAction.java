...
public class MieterSuchenAction extends MenuManager implements Action {
            ...
            try {
                ...
                if (eingabe == 8) {
                    ...
                    for (Mieter owner : MenuManager.currentManager.getOwnerList()) {
                        ...
                        if (vgl_mieterID == such_mieterID && vgl_name.contains(such_name) && vgl_vorname.contains(such_vorname) && vgl_wohnung == such_wohnung && vgl_EMail.contains(such_EMail) && vgl_adresse_straße.contains(such_adresse_straße) && vgl_adresse_stadt.contains(such_adresse_stadt) && vgl_adresse_hausnummer == such_adresse_hausnummer && vgl_adresse_platz == such_adresse_platz
