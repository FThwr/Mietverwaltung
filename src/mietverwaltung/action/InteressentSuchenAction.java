            ...
            try {
                ...
                if (eingabe == 7) {
                    ...
                    for (Interessent interest : MenuManager.currentManager.getInterestList()) {
                        ...
                        if (vgl_interessentenID == such_interessentenID && vgl_name.contains(such_name) && vgl_vorname.contains(such_vorname) && vgl_EMail.contains(such_EMail) && vgl_adresse_straße.contains(such_adresse_straße) && vgl_adresse_stadt.contains(such_adresse_stadt) && vgl_adresse_hausnummer == such_adresse_hausnummer && vgl_adresse_platz == such_adresse_platz
