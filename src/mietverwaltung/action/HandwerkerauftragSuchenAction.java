...
public class HandwerkerauftragSuchenAction extends MenuManager implements Action {
            ...
            try {
                ...
                if (eingabe == 8) {
                    ...
                    for (Handwerkerauftrag repair : MenuManager.currentManager.getRepairList()) {
                        ...
                        if (vgl_auftragsID.equals(such_auftragsID) && vgl_wohnungsID == such_wohnungsID && vgl_mitarbeiterID == such_mitarbeiterID && vgl_mängelbeschreibung.contains(such_mängelbeschreibung) && vgl_status.contains(such_status) && vgl_eingangsTag == such_eingangsTag && vgl_eingangsMonat == such_eingangsMonat && vgl_eingangsJahr == such_eingangsJahr && vgl_fertigTag == such_fertigTag
                                && vgl_fertigMonat == such_fertigMonat && vgl_fertigJahr == such_fertigJahr) {
