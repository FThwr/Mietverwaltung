...
public class WohnungSuchenAction extends MenuManager implements Action {
    ...
    public void action() {
        ...
        String[] suche = { "Wohnungsnummer", "Zimmeranzahl", "Fläche", "Kosten", "Etage", "Balkon", "Fußbodenheizung", "Aussicht", "Adresse", "Status", "letztes Renovierungsdatum", "Renoveringsanzahl", "Handwerkerauftrag", "zugeordneter Mitarbeiter" };
        ...
        while (suchVorgang == true) {
            ...
            if (ok == 15) {
                ...
                for (Wohnung flat : MenuManager.currentManager.getFlatList()) {
                    ...
                    if (vgl_wohnungsnummer == such_wohnungsnummer && vgl_zimmeranzahl == such_zimmeranzahl && vgl_fläche == such_fläche && vgl_kosten == such_kosten && vgl_etage == such_etage && vgl_balkon == such_balkon && vgl_fußbodenheizung == such_fußbodenheizung && vgl_aussicht.contains(such_aussicht) && vgl_platz == such_platz && vgl_status.contains(such_status) && vgl_monat == such_monat
