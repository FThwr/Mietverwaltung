...
public class MietvertragErstellenAction extends MenuManager implements Action {
    ...
    public void action() {
        ...
        while (erstellVorgang == true) {
            ...
            if (ok == 1) {
                ...
                if (vorhanden == 1) {
                    System.out.println("\n------------------------------- Fehler! ------------------------------- \nDer Mietvertrag mit der Nummer: " + "'" + mietvertragID + "'" + " existiert bereits!\n");
                    mietvertragID = "";
                }
            }
            if (ok == 2) {
                ...
                if (vorhanden != 1) {
                    System.out.println("\n------------------------------- Fehler! ------------------------------- \nDie Wohnung mit der Nummer: " + "'" + wohnungsID + "'" + " existiert nicht!\n");
                    wohnungsID = -100;
                }
            }
            if (ok == 3) {
                ...
                if (vorhanden != 1) {
                    System.out.println("\n------------------------------- Fehler! ------------------------------- \nDer Kunde mit der Nummer: " + "'" + kundenID + "'" + " existiert nicht!\n");
                    kundenID = -100;
                }
            }
            if (ok == 4) {
                ...
                if (vorhanden != 1) {
                    System.out.println("\n------------------------------- Fehler! ------------------------------- \nDer Mitarbeiter mit der Nummer: " + "'" + mitarbeiterID + "'" + " existiert nicht!\n");
                    mitarbeiterID = -100;
                }
            }
            if (ok == 5) {
