...
public class MietvertragBearbeitenAction extends MenuManager implements Action {
        ...
        try {
            ...
            if (mietvertragEingabe_erfolgreich == true) {
                while (bearbeitungsVorgang == true) {
                    ...
                    System.out.println("5. Mietbeginn:           " + MB_Leerzeichen + aktuellerMietbeginn + "neuer Mietbeginn:          " + neuerMietbeginn);
                    System.out.println("6. Mietende:             " + ME_Leerzeichen + aktuellesMietende + "neues Mietende:            " + neuesMietende);
