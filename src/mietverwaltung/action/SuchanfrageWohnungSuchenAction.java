...
import mietverwaltung.Bedingung;
...
public class SuchanfrageWohnungSuchenAction extends MenuManager implements Action, Serializable {
    ...
    public void action() {
        ...
        System.out.println("________________________________________ Kundenwunsch: Wohnung suchen ________________________________________");
        ...
        while (suchVorgang == true) {
            ...
            try {
                ...
                if (eingabe == 8) {
                    ...
                    erg = xxx(this.flatList, bedingungList);

                    MenuManager.currentManager.add(new Suchanfrage(SuchanfrageWohnungSuchenAction.such_mitarbeiterID, SuchanfrageWohnungSuchenAction.such_kundenID, such_zimmeranzahl, such_fläche, such_kosten, such_etage, such_balkon, such_fußbodenheizung, such_aussicht));
    ...
    private void jFrameErstellen_Interessent() {
        ...
        meinRahmen.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(final WindowEvent e) {
                SuchanfrageWohnungSuchenAction.fenster = true;
            }
        });

        JComboBox combo2 = new JComboBox();
        combo2.addItem("" + 0);
        for (Interessent interest : this.interestList) {
        ...
        while (SuchanfrageWohnungSuchenAction.fenster == false) {
    ...
    private void jFrameErstellen_Mitarbeiter() {
        ...
        JComboBox combo2 = new JComboBox();
        combo2.addItem("" + 0);
        for (Mitarbeiter worker : this.workerList) {
    ...
    private void löschen(final int aktuellesKriterium, final ArrayList<Bedingung> listeVonBedingungen) {
