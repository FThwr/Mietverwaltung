...
public class MietvertragSuchenAction extends MenueManager implements Action {
			...
			try {
				...
				if (eingabe == 7) {
					...
					for (Mietvertrag contract : contractList) {
						...
						if (vgl_mietvertragID.equals(such_mietvertragID) && vgl_wohnungsID == such_wohnungsID && vgl_kundenID == such_kundenID
								&& vgl_mitarbeiterID == such_mitarbeiterID && vgl_beginnMonat == such_beginnMonat && vgl_beginnJahr == such_beginnJahr
