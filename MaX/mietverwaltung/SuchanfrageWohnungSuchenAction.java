		...
		while (suchVorgang == true) {
			...
			try {
				...
				if (eingabe == 8) {
					...
					searchList.add(new Suchanfrage (such_mitarbeiterID , such_kundenID, such_zimmeranzahl, such_fläche, such_kosten, such_etage, such_balkon, such_fußbodenheizung, such_aussicht));
