...
public class MieterBearbeitenAction extends MenueManager implements Action, Serializable {
	...
	public void action() {
		...
		System.out.println(
				"________________________________________ Mieter bearbeiten ________________________________________\n");

		bearbeitungsAuswahl_mieterID = -100;
		...
		int zu_bearbeitenden_mieter = bearbeitungsAuswahl_mieterID;
		...
		while (bearbeitungsVorgang == true) {
			...
			System.out.println(
					"1.  Mieter ID:       " + längenAnpassung_mieterID + "neue Mieter ID:       " + neueMieterID);
			System.out.println("2.  Name:            " + längenAnpassung_Name + "neuer Name:           " + neuerName);
			System.out.println(
					"3.  Vorname:         " + längenAnpassung_Vorname + "neuer Vorame:         " + neuerVorname);
			System.out.println("4.  Geburtsdatum:    " + GD_Leerzeichen + "neues Geburtsdatum:   " + neuesGeburtsdatum);
			System.out.println(
					"5.  Wohnung:         " + längenAnpassnung_Wohnung + "neue Wohnung:         " + neueWohnung);
			...
			System.out.println("8.  Telefonnummer:   " + längenAnpassung_Telefonnummer + "neue Telefonnummer:   "
					+ neueTelefonnummer);
			...
			try {
				...
				if (änderung == 1) {
					...
					if (eingabe == 0) {
						 ...
						 * übereinstimmt.
						 */
						for (Mieter ehermaligerMieter : ehemaligeMieter) {
				...
				if (änderung == 9) {
					...
					System.out.println(
							"Geben Sie die Zahl vom gewünschten Status aus: 1 = Mieter, 2 = Delete\n");
				...
				if (änderung == 10) {
					...
					if (neueRolle.equals("Delete")) {
						...
						ehemaligeMieter.add(new Mieter(neueMieterID, neuerName, neuerVorname, neuesGeburtsdatum,
								neueWohnung, neueEMail, neueAdresse, neueTelefonnummer, "Mieter"));
	...
	/**
	 * Methode zum Anpassen der Länge der Adresse bei der Ausgabe auf der
	 * Konsole.
	 * 
	 */
