		...
		while (bearbeitungsVorgang == true) {
			...
			try {
				...
				if (änderung == 9) {
					...
					System.out.println(
							"Geben Sie die Zahl vom gewünschten Status aus: " + "1" + auswahl[0] + "2" + auswahl[1]);
				...
				if (änderung == 10) {
					...
					if (neueRolle.equals("Delete")) {
						...
						ehemaligeMieter.add(new Mieter(neueMieterID, neuerName, neuerVorname, neuesGeburtsdatum, neueWohnung, neueEMail, neueAdresse, neueTelefonnummer, "Mieter"));
